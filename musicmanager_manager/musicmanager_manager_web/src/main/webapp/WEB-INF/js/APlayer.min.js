                ...
                key: "switch", value: function (e) {
                    ...
                    if (!this.parsed[e]) if (this.async) {
                        ...
                        n.onreadystatechange = function () {
                            e === t.player.list.index && 4 === n.readyState && (n.status >= 200 && n.status < 300 || 304 === n.status ? t.parsed[e] = t.parse(n.responseText) : (t.parsed[e] = [["00:00", "Lrc isn't found"]]), t.container.innerHTML = (0, o.default)({lyrics: t.parsed[e]}), t.update(0), t.current = t.parsed[e])
                        };                                                                                                                                                      //t.player.notice("LRC file request fails: status " + n.status),
                        var i = this.player.list.audios[e].lrc;
                        n.open("get", i, !0), n.send(null)
                    } else this.player.list.audios[e].lrc ? this.parsed[e] = this.parse(this.player.list.audios[e].lrc) : this.parsed[e] = [["00:00", "Welcome To Xin-Music"]];
                    ...
                    if (e) {
                        for (var t = (e = e.replace(/([^\]^\n])\[/g, function (e, t) {
                            ...
                            var r = t[a].match(/\[(\d{2}):(\d{2})(\.(\d{2,3}))?]/g),
                                o = t[a].replace(/.*\[(\d{2}):(\d{2})(\.(\d{2,3}))?]/g, "").replace(/<(\d{2}):(\d{2})(\.(\d{2,3}))?>/g, "").replace(/^\s+|\s+$/g, "").replace(/\\n/g,"").replace(/\"}(.*?)0\}/g,"");
